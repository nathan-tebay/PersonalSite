(function () {
  ...
  function updatePostSeo (meta, slug) {
    const title = String(meta.title || 'Blog') + ' - Tebay.dev'
    const description = String(meta.desc || 'A blog post by Nathan Tebay.')
    const url = 'https://tebay.dev/blog-post.html?slug=' + encodeURIComponent(slug || '')
